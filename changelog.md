...
* [LOCAL PATCH] Bump vendored librdkafka to v2.15.1 (from v2.12.1).
  ...
  (required on Windows where win32_config.h is skipped).
  Notable upstream fixes pulled in: timer data race + LeaveGroup SIGSEGV
  (2.14.2), CMake-build rd_atomic32/64_set non-atomic fallback breaking
  ALL_BROKERS_DOWN (2.15.0), bundled OpenSSL/libcurl CVEs (2.14.2/2.15.1).
